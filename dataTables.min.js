...
!function(n) {
    ...
    function o(t, e, n) {
        var a = typeof t
          , r = "string" == a;
        return "number" == a || "bigint" == a || !!y(t) || (e && r && (t = R(t, e)),
        n && r && (t = t.replace(P, "")),
    ...
    var C, U, e, t, $ = function(t, H) {
        var W, X, B;
        return $.factory(t, H) ? $ : this instanceof $ ? V(t).DataTable(H) : (X = void 0 === (H = t),
        B = (W = this).length,
        X && (H = {}),
        this.api = function() {
            return new U(this)
        ...
        this.each(function() {
            ...
            if ("table" != this.nodeName.toLowerCase())
                ...
                null !== t && "" !== t || (t = "DataTables_Table_" + $.ext._unique++,
                this.id = t);
                ...
                u.oClasses)
                  , d = (V.extend(c, $.ext.classes, n.oClasses),
                o.addClass(c.table),
                    ...
                    for (g = T.length - 1; 0 <= g; g--) {
                        ...
                        b = I.length; v < b; v++) {
                            ...
                            if ("number" == typeof A && 0 <= A) {
                                ...
                                for (y = 0,
                                D = C.length; y < D; y++)
                                    "_all" === A ? _(y, x) : -1 !== A.indexOf(":name") ? C[y].sName === A.replace(":name", "") && _(y, x) : M.forEach(function(t) {
                                        t[y] && (t = V(t[y].cell),
                                        A.match(/^[a-z][\w-]*$/i) && (A = "." + A),
                                        t.is(A)) && _(y, x)
                                    })
                ...
                V(P[0]).children("th, td").each(function(t, e) {
                    ...
                    a.mData === t && (n = L(e, "sort") || L(e, "order"),
                ...
                u.oFeatures), O = function() {
                    ...
                    var e = o.children("caption")
                      , e = (u.caption && (e = 0 === e.length ? V("<caption/>").appendTo(o) : e).html(u.caption),
                    e.length && (e[0]._captionSide = e.css("caption-side"),
                    u.captionNode = e[0]),
                    0 === h.length && (h = V("<thead/>").appendTo(o)),
                    u.nTHead = h[0],
                    V("tr", h).addClass(c.thead.row),
                    o.children("tbody"))
                      , e = (0 === e.length && (e = V("<tbody/>").insertAfter(h)),
                    u.nTBody = e[0],
                    o.children("tfoot"));
                    if (0 === e.length && (e = V("<tfoot/>").appendTo(o)),
                    u.nTFoot = e[0],
                    ...
                    n.aaData)
                        ...
                        "dom" == et(u) && ut(u, V(u.nTBody).children("tr"));
                ...
                N = O,
                (F = u).oFeatures.bStateSave ? void 0 !== (j = F.fnStateLoadCallback.call(F.oInstance, F, function(t) {
                    Jt(F, t, N)
                })) && Jt(F, j, N) : N()) : O()
            }
        }),
    ...
    {}), d = /[\r\n\u2028]/g, L = /<([^>]*>)/g, F = Math.pow(2, 28), N = /^\d{2,4}[./-]\d{1,2}[./-]\d{1,2}([T ]{1}\d{1,2}[:.]\d{2}([.:]\d{2})?)?$/, j = new RegExp("(\\" + ["/", ".", "*", "+", "?", "|", "(", ")", "[", "]", "{", "}", "\\", "$", "^", "-"].join("|\\") + ")","g"), P = /['\u00A0,$£€¥%\u2009\u202F\u20BD\u20a9\u20BArfkɃΞ]/gi, y = function(t) {
        return !t || !0 === t || "-" === t
    }, R = function(t, e) {
        return c[e] || (c[e] = new RegExp(Pt(e),"g")),
    ...
    function z(e, n, a) {
        ...
        e._hungarianMap || k(e),
        V.each(n, function(t) {
            void 0 === (r = e._hungarianMap[t]) || !a && void 0 !== n[r] || ("o" === r.charAt(0) ? (n[r] || (n[r] = {}),
            V.extend(!0, n[r], n[t]),
            z(e[r], n[r], a)) : n[r] = n[t])
        })
    }
    ...
    function ot(t, e, n) {
        ...
        r.mData)
          , i = J(o);
        r.mRender && Array.isArray(r.mRender) && (n = (e = r.mRender.slice()).shift(),
    ...
    function M(t) {
        ...
        if (e.oFeatures.bAutoWidth) {
            var n, a, r = e.nTable, o = e.aoColumns, i = e.oScroll, l = i.sY, s = i.sX, i = i.sXInner, u = X(e, "bVisible"), c = r.getAttribute("width"), d = r.parentNode, f = r.style.width, f = (f && -1 !== f.indexOf("%") && (c = f),
            tt(e, null, "column-calc", {
                visible: u
            }, !1),
            V(r.cloneNode()).css("visibility", "hidden").removeAttr("id")), h = (f.append("<tbody>"),
            V("<tr/>").appendTo(f.find("tbody")));
            for (f.append(V(e.nTHead).clone()).append(V(e.nTFoot).clone()),
            f.find("tfoot th, tfoot td").css("width", ""),
            f.find("thead th, thead td").each(function() {
                var t = lt(e, this, !0, !1);
                t ? (this.style.width = t,
                s && V(this).append(V("<div/>").css({
                    width: t,
                    margin: 0,
                    padding: 0,
                    border: 0,
            ...
            v.remove(),
            c && (r.style.width = A(c)),
            !c && !s || e._reszEvt || (V(q).on("resize.DT-" + e.sInstance, $.util.throttle(function() {
                e.bDestroying || M(e)
            })),
            e._reszEvt = !0)
        }
        ...
        for (var e, n, a, r, o, i, l, s = t.aoColumns, u = t.aoData, c = $.ext.type.detect, d = 0, f = s.length; d < f; d++) {
            ...
            !(o = s[d]).sType && o._sManualType)
                ...
                n = c.length; e < n; e++) {
                    ...
                    r = u.length; a < r; a++)
                        if (u[a]) {
                            if (void 0 === l[a] && (l[a] = G(t, a, d, "type")),
    ...
    function G(t, e, n, a) {
        ...
        if (r) {
            ...
            if (void 0 === (s = "display" !== a && s && "object" == typeof s && s.nodeName ? s.innerHTML : s))
                return t.iDrawError != o && null === l && (Z(t, 0, "Requested unknown parameter " + ("function" == typeof i.mData ? "{function}" : "'" + i.mData + "'") + " for row " + e + ", column " + n, 4),
                t.iDrawError = o),
                l;
    ...
    function gt(t, e, n, a) {
        ...
        "dom" !== n && (n && "auto" !== n || "dom" !== i.src)) {
            ...
            i._aData = mt(t, i, a, void 0 === a ? void 0 : i._aData).data;
        var u = t.aoColumns;
        if (void 0 !== a)
            u[a].sType = null,
    ...
    function mt(t, e, n, a) {
        ...
        function o(t) {
            ...
            r(l.mData.sort, t),
            r(l.mData.type, t),
            r(l.mData.filter, t)) : h ? (l._setter || (l._setter = m(l.mData)),
            l._setter(a, s)) : a[d] = s),
            d++
        }
    ...
    function yt(t, e) {
        ...
        a.DT_RowData) && V(n).data(a.DT_RowData)
    }
    function Dt(t, e) {
        var n, a = t.oClasses, r = t.aoColumns, o = "header" === e ? t.nTHead : t.nTFoot, i = "header" === e ? "sTitle" : e;
        if (o) {
            if (("header" === e || f(t.aoColumns, i).join("")) && 1 === (n = (n = V("tr", o)).length ? n : V("<tr/>").appendTo(o)).length)
                for (var l = V("td, th", n).length, s = r.length; l < s; l++)
                    V("<th/>").html(r[l][i] || "").appendTo(n);
            var u = It(t, o, !0);
            "header" === e ? t.aoHeader = u : t.aoFooter = u,
            V(o).children("tr").attr("role", "row"),
            V(o).children("tr").children("th, td").each(function() {
                te(t, e)(t, V(this), a)
            })
        }
    }
    ...
    function S(t, e) {
        ...
        -1 !== tt(t, "aoPreDrawCallback", "preDraw", [t]).indexOf(!1))
            ...
            var l, n = [], a = 0, r = "ssp" == et(t), o = t.aiDisplay, i = t._iDisplayStart, s = t.fnDisplayEnd(), u = t.aoColumns, c = V(t.nTBody);
            if (t.bDrawing = !0,
            r) {
                if (!t.bDestroying && !e)
                    return 0 === t.iDraw && c.empty().append(Tt(t)),
                    (l = t).iDraw++,
                    w(l, !0),
                    void At(l, function(e) {
                        function n(t, e) {
            ...
            if (0 !== o.length)
                for (var d = r ? t.aoData.length : s, f = r ? 0 : i; f < d; f++) {
                    for (var h = o[f], p = t.aoData[h], g = (null === p.nTr && bt(t, h),
    ...
    function Tt(t) {
        var e = t.oLanguage
          , n = e.sZeroRecords
          , a = et(t);
        return t.iDraw < 1 && "ssp" === a || t.iDraw <= 1 && "ajax" === a ? n = e.sLoadingRecords : e.sEmptyTable && 0 === t.fnRecordsTotal() && (n = e.sEmptyTable),
        V("<tr/>").append(V("<td />", {
            colSpan: W(t),
    ...
    function _t(o, i) {
        function l(t, e) {
            return C.features[t] || Z(o, 0, "Unknown feature: " + t),
            C.features[t].apply(this, [o, e])
        }
        V.each(i, function(t) {
            for (var e, n = i[t].contents, a = 0, r = n.length; a < r; a++)
                n[a] && ("string" == typeof n[a] ? n[a] = l(n[a], null) : V.isPlainObject(n[a]) ? n[a] = l(n[a].feature, n[a].opts) : "function" == typeof n[a].node ? n[a] = n[a].node(o) : "function" == typeof n[a] && (e = n[a](o),
                n[a] = "function" == typeof e.node ? e.node() : e))
        })
    }
    function Ct(e) {
        var a, t = e.oClasses, n = V(e.nTable), r = V("<div/>").attr({
            id: e.sTableId + "_wrapper",
            class: t.container
        }).insertBefore(n);
        if (e.nTableWrapper = r[0],
        e.sDom)
            for (var o, i, l, s, u, c, d = e, t = e.sDom, f = r, h = t.match(/(".*?")|('.*?')|./g), p = 0; p < h.length; p++)
                ...
                p++),
                f.append(l),
                f = l) : ">" == i ? f = f.parent() : "t" == i ? o = Wt(d) : $.ext.feature.forEach(function(t) {
    ...
    function It(t, e, n) {
        for (var a, r, o, i, l, s, u = t.aoColumns, c = V(e).children("tr"), d = e && "thead" === e.nodeName.toLowerCase(), f = [], h = 0, p = c.length; h < p; h++)
            f.push([]);
        for (h = 0,
        p = c.length; h < p; h++)
    ...
    function At(n, t, a) {
        ...
        var r, o = n.ajax, i = n.oInstance, l = (V.isPlainObject(o) && o.data && (l = "function" == typeof (r = o.data) ? r(t, n) : r,
        ...
        delete o.data),
        {
            ...
            error: function(t, e) {
                -1 === tt(n, null, "xhr", [n, null, n.jqXHR], !0).indexOf(!0) && ("parsererror" == e ? Z(n, 0, "Invalid JSON response", 1) : 4 === t.readyState && Z(n, 0, "Ajax error", 7)),
                w(n, !1)
            }
        });
        ...
        "function" == typeof o ? n.jqXHR = o.call(i, t, e, n) : "" === o.url ? (i = {},
        $.util.set(o.dataSrc)(i, []),
        e(i)) : (n.jqXHR = V.ajax(l),
        r && (o.data = r))
    }
    function Lt(t, e, n) {
        var a = "data";
        if (V.isPlainObject(t.ajax) && void 0 !== t.ajax.dataSrc && ("string" == typeof (t = t.ajax.dataSrc) || "function" == typeof t ? a = t : void 0 !== t.data && (a = t.data)),
        !n)
    ...
    function Ft(t, e, n) {
        ...
        return t && t[e] ? J(t[e])(n) : (t = "",
        "draw" === e ? t = "sEcho" : "recordsTotal" === e ? t = "iTotalRecords" : "recordsFiltered" === e && (t = "iTotalDisplayRecords"),
        void 0 !== n[t] ? n[t] : n[e])
    }
    function Nt(n, t) {
            ...
            for (var a, r, o, i, l, s = n, u = s.aoColumns, c = s.aoData, d = 0; d < c.length; d++)
                if (c[d] && !(l = c[d])._aFilterData) {
                    ...
                    r = u.length; a < r; a++)
                        ...
                        i.indexOf && -1 !== i.indexOf("&") && (Rt.innerHTML = i,
    ...
    function jt(t, e, n, a, r) {
        if ("" !== n) {
            for (var o = 0, i = [], l = "function" == typeof n ? n : null, s = n instanceof RegExp ? n : l ? null : function(t, e) {
                ...
                if (t = O(t),
                e.exact)
                    return new RegExp("^" + Pt(t) + "$",e.caseInsensitive ? "i" : "");
                {
                    var n, r, o;
                    t = e.regex ? t : Pt(t),
                    e.smart && (n = (t.match(/!?["\u201C][^"\u201D]+["\u201D]|[^ ]+/g) || [""]).map(function(t) {
                        var e, n = !1;
                        return "!" === t.charAt(0) && (n = !0,
                        t = t.substring(1)),
                        '"' === t.charAt(0) ? t = (e = t.match(/^"(.*)"$/)) ? e[1] : t : "“" === t.charAt(0) && (t = (e = t.match(/^\u201C(.*)\u201D$/)) ? e[1] : t),
                        n && (1 < t.length && a.push("(?!" + t + ")"),
                        t = ""),
                        t.replace(/"/g, "")
                    }),
                    r = a.length ? a.join("") : "",
    ...
    function Wt(t) {
        ...
        return "" === g.sX && "" === g.sY ? t.nTable : (e = g.sX,
        n = g.sY,
            ...
            if (n.length) {
                for (var a = 0, r = n.length; a < r; a++)
                    if (!1 !== function(t, e, n, a) {
                        ...
                        (a || n) && t.oFeatures.bSortMulti ? -1 !== (i = f(l, "0").indexOf(e)) ? null === (o = null === (o = r(l[i], !0)) && 1 === l.length ? 0 : o) ? l.splice(i, 1) : (l[i][1] = s[o],
                        l[i]._idx = o) : (a ? l.push([e, s[0], 0]) : l.push([e, l[0][1], 0]),
    ...
    function Ut(n, a, t) {
        ...
        if (V.isPlainObject(t))
            e(t);
        else if (t.length && "number" == typeof t[0])
            e(t);
        else if (t.length)
    ...
    function $t(t) {
        var e, n, a, r, o, i, l, s = [], u = $.ext.type.order, c = t.aoColumns, d = t.aaSortingFixed, f = V.isPlainObject(d), h = [];
        if (t.oFeatures.bSort)
            for (Array.isArray(d) && Ut(t, h, d),
    ...
    function zt(t, e, n) {
        ...
        if ("ssp" != et(t) && 0 !== c.length) {
            ...
            0 === c.length && u.sort(function(t, e) {
                return t < e ? -1 : e < t ? 1 : 0
            });
        return void 0 === e && (t.bSorted = !0,
        tt(t, null, "order", [t, c])),
        u
    }
    function Yt(t) {
    ...
    function Jt(n, t, e) {
        ...
        if (t && t.time) {
            ...
            if (0 < l && t.time < +new Date - 1e3 * l)
                n._bLoadingState = !1;
            else if (-1 !== tt(n, "aoStateLoadParams", "stateLoadParams", [n, t]).indexOf(!1))
                n._bLoadingState = !1;
            else if (t.columns && o.length !== t.columns.length)
                n._bLoadingState = !1;
            else {
                if (n.oLoadedState = V.extend(!0, {}, t),
                tt(n, null, "stateLoadInit", [n, t], !0),
                void 0 !== t.length && (i ? i.page.len(t.length) : n._iDisplayLength = t.length),
                void 0 !== t.start && (null === i ? (n._iDisplayStart = t.start,
                n.iInitDisplayStart = t.start) : Ht(n, t.start / n._iDisplayLength)),
                void 0 !== t.order && (n.aaSorting = [],
    ...
    function Z(t, e, n, a) {
        ...
        e)
            ...
            if (t && tt(t, null, "dt-error", [t, a, n], !0),
            "alert" == e)
                alert(n);
            else {
                if ("throw" == e)
    ...
    function Zt(t, e, n) {
        ...
        for (r in e)
            ...
            V.isPlainObject(a) ? (V.isPlainObject(t[r]) || (t[r] = {}),
            V.extend(!0, t[r], a)) : n && "data" !== r && "aaData" !== r && Array.isArray(a) ? t[r] = a.slice() : t[r] = a);
        return t
    }
    function Qt(t, e, n) {
    ...
    U = function(t, e) {
        ...
        function n(t) {
            ...
            e = $.settings,
            a = f(e, "nTable");
            var n, e, a, r = t ? t.nTable && t.oFeatures ? [t] : t.nodeName && "table" === t.nodeName.toLowerCase() ? -1 !== (r = a.indexOf(t)) ? [e[r]] : null : t && "function" == typeof t.settings ? t.settings().toArray() : ("string" == typeof t ? n = V(t).get() : t instanceof V && (n = t.get()),
        ...
        iterator: function(t, e, n, a) {
            ...
            i = h.length; o < i; o++) {
                ...
                if ("table" === e)
                    ...
                    s = c.length; l < s; l++)
                        d = c[l],
                        void 0 !== (r = "cell" === e ? n.call(g, h[o], d.row, d.column, o, l) : n.call(g, h[o], d, o, l, u)) && f.push(r)
            }
            return f.length || a ? ((t = (a = new U(h,t ? f.concat.apply([], f) : f)).selector).rows = p.rows,
            t.cols = p.cols,
            t.opts = p.opts,
            a) : this
        },
    ...
    U.extend = function(t, e, n) {
        if (n.length && e && (e instanceof U || e.__dt_wrapper))
            for (var a, r = 0, o = n.length; r < o; r++)
                "__proto__" !== (a = n[r]).name && (e[a.name] = "function" === a.type ? function(e, n, a) {
                    return function() {
    ...
    U.register = e = function(t, e) {
        if (Array.isArray(t))
            ...
            for (var r = t.split("."), o = ne, i = 0, l = r.length; i < l; i++) {
                ...
                i === l - 1 ? (c.val = e,
                c.type = "function" == typeof e ? "function" : V.isPlainObject(e) ? "object" : "other") : o = s ? c.methodExt : c.propExt
            }
    }
    ,
    ...
    function oe(t, e, n, a, r) {
        for (var o, i, l, s, u = [], c = typeof e, d = 0, f = (e = e && "string" != c && "function" != c && void 0 !== e.length ? e : [e]).length; d < f; d++)
            for (l = 0,
            s = (i = e[d] && e[d].split && !e[d].match(/[[(:]/) ? e[d].split(",") : [e[d]]).length; l < s; l++)
    ...
    function ie(t) {
        return (t = t || {}).filter && void 0 === t.search && (t.search = t.filter),
        V.extend({
            search: "none",
            order: "current",
            page: "all"
    ...
    e("caption()", function(r, o) {
        ...
        return void 0 === r ? (t = e[0].captionNode) && e.length ? t.innerHTML : null : this.iterator("table", function(t) {
            ...
            n[0]._captionSide = o),
            (a.find("div.dataTables_scroll").length ? (t = "top" === o ? "Head" : "Foot",
            a.find("div.dataTables_scroll" + t + " table")) : e).prepend(n)
        }, 1)
    }),
    ...
    e("page.info()", function() {
        ...
        if (0 !== this.context.length)
            return e = (t = this.context[0])._iDisplayStart,
    ...
    e("ajax.url()", function(e) {
        var t = this.context;
        return void 0 === e ? 0 === t.length ? void 0 : (t = t[0],
        V.isPlainObject(t.ajax) ? t.ajax.url : t.ajax) : this.iterator("table", function(t) {
    ...
    function se(o, i, t, e) {
        function l(t, e) {
            ...
            if (Array.isArray(t) || t instanceof V)
                ...
                t.nodeName && "tr" === t.nodeName.toLowerCase() ? (t.setAttribute("data-dt-row", i.idx),
                s.push(t)) : (n = V("<tr><td></td></tr>").attr("data-dt-row", i.idx).addClass(e),
    ...
    function ue(t, e) {
        ...
        if (n.length && t.length) {
            ...
            if (a._details) {
                ...
                V(a.nTr).addClass("dt-hasChild")) : (a._details.detach(),
    ...
    function fe(e, n) {
        return function(t) {
            return y(t) || "string" != typeof t || (t = t.replace(d, " "),
            e && (t = I(t)),
            n && (t = O(t, !1))),
            t
        }
    ...
    var he = function(t, e) {
        ...
        if ("current" == e)
            ...
            c = t.aoData.length; u < c; u++)
                t.aoData[u] && ("none" == i || -1 === (n = r.indexOf(u)) && "removed" == i || 0 <= n && "applied" == i) && a.push(u);
      ...
      , pe = (e("rows()", function(n, a) {
        void 0 === n ? n = "" : V.isPlainObject(n) && (a = n,
        n = ""),
        a = ie(a);
    ...
    t("rows().remove()", "row().remove()", function() {
        return this.iterator("row", function(t, e) {
            var n = t.aoData
              ...
              , r = (-1 !== r && t.aiDisplayMaster.splice(r, 1),
            0 < t._iRecordsDisplay && t._iRecordsDisplay--,
            Kt(t),
            t.rowIdFn(a._aData));
            void 0 !== r && delete t.aIds[r],
            n[e] = null
        }),
        this
    }),
    ...
    e("row().data()", function(t) {
        ...
        return void 0 === t ? n.length && this.length && this[0].length ? n[0].aoData[this[0]]._aData : void 0 : ((e = n[0].aoData[this[0]])._aData = t,
    ...
    function(t, e) {
      ...
      , me = function(t, e) {
        var n = t.context;
        n.length && (e = n[0].aoData[void 0 !== e ? e : t[0]]) && e._details && (e._details.remove(),
      ...
      , ye = (e(be, function(t, e) {
        var n = this.context;
        return void 0 === t ? n.length && this.length && n[0].aoData[this[0]] ? n[0].aoData[this[0]]._details : void 0 : (!0 === t ? this.child.show() : !1 === t ? me(this) : n.length && this.length && se(n[0], n[0].aoData[this[0]], t, e),
        this)
    }),
    ...
    e("cells()", function(g, t, m) {
        var a, r, o, i, l, s, e;
        return V.isPlainObject(g) && (void 0 === g.row ? (m = g,
        g = null) : (m = t,
        t = null)),
        V.isPlainObject(t) && (m = t,
        t = null),
        null == t ? this.iterator("table", function(t) {
            return a = t,
            t = g,
            e = ie(m),
            d = a.aoData,
                ...
                if (null == t || n) {
                    ...
                    l = f.length; i < l; i++)
                        ...
                        s = 0; s < p; s++)
                            ...
                            (!n || (c = d[r],
                            t(u, G(a, r, s), c.anCells ? c.anCells[s] : null))) && o.push(u);
                    return o
                }
    ...
    e("cell().data()", function(t) {
        ...
        return void 0 === t ? i.length && l.length ? G(i[0], l[0].row, l[0].column) : void 0 : (e = i[0],
        n = l[0].row,
        a = l[0].column,
        r = e.aoColumns[a],
        o = e.aoData[n]._aData,
    ...
    e("order()", function(e, t) {
        ...
        return void 0 === e ? 0 !== n.length ? n[0].aaSorting : void 0 : ("number" == typeof e ? e = [[e, t]] : 1 < a.length && (e = a),
    ...
    e("search.fixed()", function(e, n) {
        var t = this.iterator(!0, "table", function(t) {
            t = t.searchFixed;
            return e ? void 0 === n ? t[e] : (null === n ? delete t[e] : t[e] = n,
            this) : Object.keys(t)
        });
    ...
    e(["columns().search.fixed()", "column().search.fixed()"], function(n, a) {
        var t = this.iterator(!0, "column", function(t, e) {
            ...
            return n ? void 0 === a ? t[n] : (null === a ? delete t[n] : t[n] = a,
            this) : Object.keys(t)
        });
    ...
    $.factory = function(t, e) {
        var n = !1;
        return t && t.document && (_ = (q = t).document),
        e && e.fn && e.fn.jquery && (V = e,
        n = !0),
        n
    }
    ,
    ...
    $.tables = function(e) {
        var t = !1
          , n = (V.isPlainObject(e) && (t = e.api,
        e = e.visible),
        $.settings.filter(function(t) {
    ...
    e("destroy()", function(c) {
        ...
        this.iterator("table", function(t) {
            ...
            t.aaSortingFixed = [],
            Yt(t),
            V("th, td", r).removeClass(u.canAsc + " " + u.canDesc + " " + u.isAsc + " " + u.isDesc).css("width", ""),
            a.children().detach(),
            a.append(s),
    ...
    V.each(["column", "row", "cell"], function(t, s) {
        e(s + "s().every()", function(a) {
            ...
            return this.iterator("every", function(t, e, n) {
                r = i[s](e, o),
                "cell" === s ? a.call(r, r[0][0].row, r[0][0].column, n, l) : a.call(r, e, n, l),
                l++
            })
        })
    }),
    ...
    function Te(t, e, n) {
        var a;
        if (q.moment) {
            if (!(a = q.moment.utc(t, e, n, !0)).isValid())
                return null
        } else if (q.luxon) {
            ...
            e ? (Se || alert("DataTables warning: Formatted date without Moment.js or Luxon - https://datatables.net/tn/17"),
            Se = !0) : a = new Date(t);
        return a
    }
    function we(s) {
        return function(a, r, o, i) {
            ...
            function(t, e) {
                var n;
                return null == t && (t = "--now" === i ? (n = new Date,
                new Date(Date.UTC(n.getFullYear(), n.getMonth(), n.getDate(), n.getHours(), n.getMinutes(), n.getSeconds()))) : ""),
                "type" === e ? l : "" === t ? "sort" !== e ? "" : Te("0000-01-01 00:00:00", null, o) : !(null === r || a !== r || "sort" === e || "type" === e || t instanceof Date) || null === (n = Te(t, a, o)) ? t : "sort" === e ? n : (t = null === r ? xe(n, "toDate", "toJSDate", "")[s]() : xe(n, "format", "toFormat", "toISOString", r),
                "display" === e ? u(t) : t)
            }
        }
    }
    ...
    var i = $.ext.type
      , Ae = ($.type = function(a, t, e) {
        ...
        void 0 === e && (e = t,
        t = null),
        "className" === t ? n("className", e) : "detect" === t ? r(e) : "order" === t ? o(e) : "render" === t ? n("render", e) : "search" === t ? n("search", e) : t || (e.className && n("className", e.className),
    ...
    function(t, e, n, a) {
        var r;
        return 0 === t || t && "-" !== t ? "number" == (r = typeof t) || "bigint" == r ? t : +(t = (t = e ? R(t, e) : t).replace && (n && (t = t.replace(n, "")),
        a) ? t.replace(a, "") : t) : -1 / 0
    }
    );
    V.extend(!0, $.ext.renderer, {
    ...
    $.feature.register("info", function(t, s) {
        var e, n, u;
        return t.oFeatures.bInfo ? (e = t.oLanguage,
        n = t.sTableId,
        u = V("<div/>", {
    ...
    function Fe(t, e, n, a) {
        ...
        case "last":
            ...
            break;
        default:
            "number" == typeof e && (o.display = t.fnFormatNumber(e + 1),
            n === e) && (o.active = !0)
        }
        return o
    }
    function Ne(t, e, n, a) {
        var r = []
          ...
          , i = a ? 2 : 1
          , l = a ? 1 : 0;
        return e <= n ? r = h(0, e) : 1 === n ? r = [t] : 3 === n ? t <= 1 ? r = [0, 1, "ellipsis"] : e - 2 <= t ? (r = h(e - 2, e)).unshift("ellipsis") : r = ["ellipsis", t, "ellipsis"] : t <= o ? ((r = h(0, n - i)).push("ellipsis"),
        a && r.push(e - 1)) : e - 1 - o <= t ? ((r = h(e - (n - i), e)).unshift("ellipsis"),
        a && r.unshift(0)) : ((r = h(t - o + i, t + o - l)).push("ellipsis"),
        r.unshift("ellipsis"),
        a && (r.push(e - 1),
        r.unshift(0))),
        r
    ...
    $.feature.register("search", function(n, t) {
        ...
        -1 === (t = V.extend({
            ...
            text: c.sSearch
        }, t)).text.indexOf("_INPUT_") && (t.text += "_INPUT_"),
        t.text = ee(n, t.text),
        ...
        (s = V("<div>").addClass(e.container).append(l.replace(/_INPUT_/, o))).find("label").attr("for", "dt-search-" + Le),
        s.find("input").attr("id", "dt-search-" + Le),
        Le++,
        u = function(t) {
            var e = this.value;
            r.return && "Enter" !== t.key || e != r.search && (r.search = e,
            Nt(n, r),
            n._iDisplayStart = 0,
            S(n))
        }
        ...
        d = V("input", s).val(r.search).attr("placeholder", t.placeholder).on("keyup.DT search.DT input.DT paste.DT cut.DT", c ? $.util.debounce(u, c) : u).on("mouseup.DT", function(t) {
            setTimeout(function() {
                u.call(d[0], t)
            }, 10)
    ...
    $.feature.register("paging", function(t, e) {
        if (!t.oFeatures.bPaginate)
            return null;
        (e = V.extend({
        ...
        return t.aoDrawCallback.push(n),
    ...
    return $.feature.register("pageLength", function(a, t) {
        var e = a.oFeatures;
        if (!e.bPaginate || !e.bLengthChange)
            return null;
        t = V.extend({
            menu: a.aLengthMenu,
        ...
        if (Array.isArray(r[0]))
            ...
            for (p = 0; p < r.length; p++)
                V.isPlainObject(r[p]) ? (o.push(r[p].value),
                i.push(r[p].label)) : (o.push(r[p]),
                i.push(r[p]));
        for (var l = t.text.match(/_MENU_$/), s = t.text.match(/^_MENU_/), u = t.text.replace(/_MENU_/, ""), t = "<label>" + t.text + "</label>", c = (s ? t = "_MENU_<label>" + u + "</label>" : l && (t = "<label>" + u + "</label>_MENU_"),
        V("<div/>").addClass(e.container).append(t.replace("_MENU_", "<span></span>"))), d = [], f = (c.find("label")[0].childNodes.forEach(function(t) {
        ...
        return c.find("label").attr("for", "dt-length-" + je),
        h.attr("id", "dt-length-" + je),
        je++,
        c.find("span").replaceWith(h),
        V("select", c).val(a._iDisplayLength).on("change.DT", function() {
            Mt(a, V(this).val()),
            S(a)
        }),
        V(a.nTable).on("length.dt.DT", function(t, e, n) {
            a === e && (V("select", c).val(n),
            f(n))
        }),
        f(a._iDisplayLength),
        c
