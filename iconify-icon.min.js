...
!function() {
    ...
    function v(t) {
        ...
        for (const t in n) {
            const e = n[t];
            if (!t.match(u) || "string" != typeof e.body || !b(e, i))
                return null
        }
    ...
    function L(t, e, n, i) {
        ...
        function y() {
            ...
            d.push(r),
            l++,
            f = setTimeout(y, t.rotate),
            n(i, e, r.callback)
        }
        return "function" == typeof i && h.push(i),
        setTimeout(y),
        function() {
            return {
                startTime: c,
    ...
    function B(t, e, n) {
        ...
        return i && r ? i.query(e, r, n)().abort : (n(void 0, 424),
        J)
    }
    const G = "iconify2"
      , V = "iconify"
    ...
    function ut(t) {
        const e = t + "Storage";
        try {
            if (at && at[e] && "number" == typeof at[e].length)
                return at[e]
        } catch (t) {}
        ot[t] = !1
    }
          ...
          , o = t => {
            ...
            if ("string" == typeof o) {
                try {
                    ...
                    if ("object" == typeof n && "number" == typeof n.cached && n.cached > r && "string" == typeof n.provider && "object" == typeof n.data && "string" == typeof n.data.prefix && e(n, t))
                        return !0
                } catch (t) {}
                nt(n, i)
            }
        ...
        if (!ct) {
            ...
            for (const t in ot)
                lt(t, (t => {
                    ...
                    return n.lastModifiedCached = n.lastModifiedCached ? Math.min(n.lastModifiedCached, i) : i,
                    !0
                }
                ))
        }
        ...
        o.forEach((t => {
            ...
            r[e][n].length && function(t, e) {
                ...
                setTimeout(( () => {
                    ...
                    i && (r = F(e)) && r.prepare(e, n, i).forEach((n => {
                        B(e, n, (e => {
                            if ("object" != typeof e)
                                n.icons.forEach((e => {
                                    t.missing.add(e)
    ...
    function kt(t, e) {
        ...
        [i, r].forEach((t => {
            const e = []
              ...
              , i = t.vFlip;
            let r, o = t.rotate;
            switch (n ? i ? o += 2 : (e.push("translate(" + (s.width + s.left).toString() + " " + (0 - s.top).toString() + ")"),
            e.push("scale(-1 1)"),
            s.top = s.left = 0) : i && (e.push("translate(" + (0 - s.left).toString() + " " + (s.height + s.top).toString() + ")"),
            e.push("scale(1 -1)"),
            s.top = s.left = 0),
            ...
            o % 2 == 1 && (s.left !== s.top && (r = s.left,
            s.left = s.top,
            s.top = r),
            s.width !== s.height && (r = s.width,
            s.width = s.height,
            s.height = r)),
            e.length && (c = function(t, e, n) {
        ...
        d = wt(h, l / f)) : (d = "auto" === a ? l : a,
        h = null === u ? wt(d, f / l) : "auto" === u ? f : u);
        const p = {}
          , g = (t, e) => {
            _t(e) || (p[t] = e.toString())
        }
    ...
    function Rt(t, e) {
        ...
        n.setAttribute(Mt, Mt),
        t.appendChild(n)),
        n.textContent = ":host{display:inline-block;vertical-align:" + (e ? "-0.125em" : "0") + "}span,svg{display:block}" + Tt
    }
    const Lt = {
        ...
        const r = ["icon", "mode", "inline", "noobserver", "width", "height", "rotate", "flip"]
          , o = class extends n {
            ...
            _iconChanged(t) {
                const e = vt(t, ( (t, e, n) => {
                    const i = this._state;
                    if (i.rendered || this.getAttribute("icon") !== t)
                        return;
                    const r = {
                        value: t,
                        name: e,
